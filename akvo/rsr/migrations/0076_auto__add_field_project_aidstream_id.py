...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.aidstream_id'
        db.add_column(u'rsr_project', 'aidstream_id',
                      self.gf('akvo.rsr.fields.ValidXMLCharField')(db_index=True, default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.aidstream_id'
        db.delete_column(u'rsr_project', 'aidstream_id')
    ...
    models = {
        ...
        'rsr.project': {
            ...
            'aidstream_id': ('akvo.rsr.fields.ValidXMLCharField', [], {'db_index': 'True', 'max_length': '100', 'blank': 'True'}),
